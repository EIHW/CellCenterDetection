    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val', 'test']:
            ...
            if phase == 'train':
                ...
                running_loss_file.write('{}, {}, {}, '.format(epoch+1, epoch_loss, 0))
                ...
                running_loss_file.write('Epoch: {}, precision: {:.3f}, recall: {:.3f}, F1: {:.3f}\n'.format(epoch_loss, precision, recall, F1))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gauss-sigma', type=float, default=0.625)
    parser.add_argument("--scalehalf", dest="scalehalf", action="store_true")
    parser.add_argument('--conv-size', type=int, default=3)
    ...
    nn_spec1 = [[1, 64//2, 2, True],
                ...
                [128//2, 256//4, 4, False],
                [256//4, 512//4, 4, False]]
    nn_spec6 = [[1, 64//2, 2, True],
                [64//2, 128//2, 3, True],
                [128//2, 256//4, 4, True],
                [256//4, 512//4, 4, False]]
    nn_spec5 = [[1, 64//2, 2, True],
                [64//2, 128//2, 3, True],
                [128//2, 256//4, 4, True],
                [256//4, 512//4, 4, False],
                [512//4, 1024//4, 4, False]]
    config_desc = '_nn_spec5_Gaussian=0.625_sstep_size=' + str(args.lr_scheduler_steps) + '_num_epochs=' + str(args.epochs) + '_size=444_lr=' + str(lr) +  ('' if post_transform else 'no') +'post-transform'
    
    net = My_Net(nn_spec5, conv_filter_size=args.conv_size)
    print(net)
