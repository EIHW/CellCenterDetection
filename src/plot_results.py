...
if __name__ == "__main__":
    ...
    custom_multiple_subplots(data_dir + "results.pdf", 2, 1, Xs, Ys, ["FCNN", "FRCNN"], fig_size=fig_size,title=titles, font_size=font_size, x_axis=x_axis, y_axis=y_axis)
    print("done")
